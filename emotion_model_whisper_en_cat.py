...
def main():
    ...
    parser.add_argument('--outdir', type=str, required=False, default='emotion_model_whisper_en_c_r1', help='Output directory for your trained checkpoints')
