...
def main():
    ...
    parser.add_argument('--outdir', type=str, required=False, default='emotion_model_clean_whisper_b6_r1', help='Output directory for your trained checkpoints')
    ...
    trainlist = os.path.join(txtfiledir, 'msp1_11-train-clean.txt')
    validlist = os.path.join(txtfiledir, 'msp1_11-dev-clean.txt')
