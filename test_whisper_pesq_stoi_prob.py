...
def main():
    ...
    parser.add_argument('--datalist', type=str, default='./txtfile/ravdess-clean-noisy-all.txt', help='Path of your DATA/ list')
    #parser.add_argument('--datalist', type=str, default='./txtfile/msp1_11-test2-clean-noisy-8-class-prob.txt', help='Path of your DATA/ list')
    ...
    emo_model = EmotionPredictor(ssl_model, SSL_OUT_DIM, device).to(device)
    emo_model.eval()
    ...
    label_map = {0:'A',1:'S', 2:'D', 3:'C', 4:'F', 5:'N', 6:'U', 7:'H'}
