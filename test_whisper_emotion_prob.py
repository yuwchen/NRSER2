...
from emotion_model_whisper_clean_prob import EmotionPredictor
...
def main():
    ...
    parser.add_argument('--datalist', type=str, default='./txtfile/msp1_11-test1-clean-8-class-prob.txt', help='Path of your DATA/ list')
