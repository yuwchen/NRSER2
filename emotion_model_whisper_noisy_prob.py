...
from utils import *
from dataloader_prob import MyDataset
...
class EmotionPredictor(nn.Module):
    ...
    def __init__(self, ssl_model, ssl_out_dim, device):
        ...
        self.output_layer_C = nn.Linear(self.ssl_features, 8) #categorical

        self.predicted_ids = torch.tensor([[1, 1]]) * self.ssl_model.config.decoder_start_token_id
        self.predicted_ids = self.predicted_ids.to(device)
...
def main():
    ...
    parser.add_argument('--outdir', type=str, required=False, default='emotion_model_whisper_noisy_prob_r1', help='Output directory for your trained checkpoints')
