...
from utils import *
from dataloader_iemocap import MyDataset
...
def main():
    ...
    parser.add_argument('--outdir', type=str, required=False, default='emotion_model_clean_whisper_iemocap_s1_b10_c10_r1', help='Output directory for your trained checkpoints')
    parser.add_argument('--trainlist', type=str, required=False, default='IEMOCAP-train-0-c10.txt', help='Output directory for your trained checkpoints')
    parser.add_argument('--devlist', type=str, required=False, default='IEMOCAP-dev-0-c10.txt', help='Output directory for your trained checkpoints')
    ...
    trainlist = os.path.join(txtfiledir, trainlist)
    validlist = os.path.join(txtfiledir, devlist)
    ...
    trainloader = DataLoader(trainset, batch_size=10, shuffle=True, num_workers=2, collate_fn=trainset.collate_fn)
    validset = MyDataset(wavdir, validlist,'whisper')
    validloader = DataLoader(validset, batch_size=10, shuffle=True, num_workers=2, collate_fn=validset.collate_fn)
