...
from emotion_model_whisper_clean_iemocap import EmotionPredictor
...
def main():
    ...
    parser.add_argument('--datalist', type=str, default='./txtfile/IEMOCAP-test-0-c10.txt', help='Path of your DATA/ list')
    ...
    label_map = {0:'hap',1:'sad',2:'neu',3:'ang',4:'exc', 5:'fru', 6:'sur', 7:'fea', 8:'oth', 9:'dis'}
